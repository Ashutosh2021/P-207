...
def gameWindow():
    ...
    # Add Text
    canvas2.create_text( screen_width/3.4,50, text = "Tambola Family Fun", font=("Chalkboard SE",50), fill="#3e2723")
    ...
    # Flash Number Label
    flashNumberLabel = canvas2.create_text(400,500, text = "Waiting for other to join...", font=("Chalkboard SE",30), fill="#3e2723")
...
def askPlayerName():
    ...
    canvas1.create_text( screen_width/3.7,screen_height/8, text = "Enter Name", font=("Chalkboard SE",60), fill="#3e2723")
